...
def process_image(img: Image.Image, format_key: str, hashtag: str) -> Image.Image:
    ...
    if hashtag and hashtag != "— Без хештега —":
        ...
        try:
            font_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "NunitoVariable.ttf")
        ...
        tx = canvas_w - HASHTAG_RIGHT - text_w
        ty = canvas_h - HASHTAG_BOTTOM - HASHTAG_SIZE
        draw.text((tx, ty), hashtag, font=font, fill=(hcr, hcg, hcb, int(255 * ALPHA)))
